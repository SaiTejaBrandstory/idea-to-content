-- Chat system schema for AI assistant
...
-- Create chat_messages table to track individual messages
...
-- Create trigger to automatically update session stats when messages are added/updated/deleted
